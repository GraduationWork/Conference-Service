...
public class GoogleOAuthHelper {
	...
	public static void authenticate(String clientId, String redirectUrl, List<String> scopes, Map<String, String> headers) throws ClientProtocolException, IOException {
